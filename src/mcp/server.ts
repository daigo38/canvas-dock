...
\`id = ComponentName(propA: ..., propB: ...)\`. A page must have a \`root = ...\`.

Available components: Stack, Heading, Text, Card, Stat, Chart (bar/line/pie),
Table, Divider, Badge. Full grammar at resource \`openui://spec/lang\`.`;
...
in the canvas-dock catalog: Text, Heading, Row, Column, List, Card, Stat, Chart,
Table, Divider, Badge, Image. Props may be literals or binding objects

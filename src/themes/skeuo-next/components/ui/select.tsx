  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        ...
        "focus:outline-none focus:border-primary/60 focus:shadow-[inset_0_1px_2px_oklch(0_0_0_/_0.1),0_0_0_3px_oklch(0.7_0.13_200_/_0.2)]",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        className={cn(
          ...
          "shadow-[0_2px_8px_oklch(0_0_0_/_0.08),0_6px_20px_oklch(0_0_0_/_0.06)]",
          position === "popper" &&

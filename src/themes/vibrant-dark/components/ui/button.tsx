...
// Dynamic Button: vibrant blue primary, neutral secondary, pill shapes, active:scale-[0.97] press animation
// Colors: primary(blue), secondary(neutral), success, warning, destructive

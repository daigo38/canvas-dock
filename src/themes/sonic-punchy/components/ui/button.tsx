...
/*
 * Sonic Punchy Button — same elevated-surface treatment, with a square-wave snap on press.
 * playTick fires on pointer-down, playClick on the actual click event.
 */
